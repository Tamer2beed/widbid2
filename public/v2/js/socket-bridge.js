...
/* ── خرائط الرتب (مطابقة تماماً لقسم 23.2 بالدستور — Qwen_markdown.md —
   نسخة White Mode لأن خلفية قائمة المتواجدين بواجهة v2 فاتحة) ── */
const WB_RANK_COLORS = {
  100: '#4A4A4A', 200: '#D81B60', 300: '#6A1B9A', 400: '#AA7C11',
  500: '#1A237E', 600: '#2E7D32', 700: '#B71C1C', 800: '#C62828',
  900: '#E65100', 1000: '#D32F2F', 1100: '#D4AF37', 1200: '#000000',
};
const WB_RANK_NAMES = {
